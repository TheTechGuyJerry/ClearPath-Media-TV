      ...
      <header className="bg-background border-b border-outline-variant w-full z-50 sticky top-0">
        <nav className="flex justify-between items-center w-full px-margin-mobile md:px-margin-desktop max-w-[1280px] mx-auto h-20">
          <div className="flex items-center gap-gutter h-full">
            <Link to="/" className="text-headline-md font-headline-md font-bold tracking-tight text-primary">
              CLEARPATH MEDIA
            </Link>
          ...
          <div className="flex items-center gap-unit-md">
            ...
            <button 
              ...
              className="hidden lg:flex bg-primary text-white font-label-sm px-4 py-2 rounded-sm uppercase tracking-wide hover:bg-primary-fixed-variant transition-colors"
            >
              Subscribe
            </button>
            <button className="lg:hidden p-2 text-on-surface-variant hover:text-primary">
