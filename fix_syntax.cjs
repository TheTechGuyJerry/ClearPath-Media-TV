...
for (const file of files) {
  ...
  c = c.replace(/<\/div>\s*<div className="max-w-\[1440px\] 2xl:max-w-\[1600px\] px-margin-mobile md:px-margin-desktop mx-auto">\s*<SubscriptionSection \/>\s*<\/div>\s*<\/div>\s*\);\s*\}\s*/, '        </div>\n      </main>\n      <div className="max-w-[1440px] 2xl:max-w-[1600px] px-margin-mobile md:px-margin-desktop mx-auto">\n        <SubscriptionSection />\n      </div>\n    </div>\n  );\n}\n');
